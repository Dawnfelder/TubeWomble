console.log("station-data.js is linked");
// Station data as a multi-line string, source: https://techforum.tfl.gov.uk/t/find-all-tfl-stoppoints/1324/3
const stationDataString = `
...
// Function to convert the station data string into a JavaScript array
function convertStationData(dataString) {
  const lines = dataString.trim().split("\n");
  // console.log(lines);
  const stationData = lines.map((line) => {
    const [code, ...nameData] = line.split(" ");
...
// Convert the station data string to a JavaScript array
const stationData = convertStationData(stationDataString);

console.log(stationData);

// console.log(JSON.stringify(stationData, null, 1));
